    ...
    $.Sena_Theme = {
        ...
        navigation: function() {
            ...
            var dropdownHide = function() {
                if (jQuery('.navbar .dropdown.open').length === 0) {
                    return;
                }
                ...
                jQuery('.navbar .dropdown.open').each(function() {
                    ...
                    $menu.find('.dropdown-menu').animate({
                        opacity: 0
                    }, {
                        duration: 150,
                        queue: false
            ...
            jQuery('a[href^=\\#]').on("click", function(e) {
                if (jQuery(this).attr('href') !== '#' && !jQuery(e.target).parent().parent().is('.navbar-nav') && !jQuery(this).attr('data-toggle')) {
                    jQuery(document).scrollTo(jQuery(this).attr('href'), Sena_Options.scrollSpeed, {
                        offset: {
                            top: -85,
                            left: 0
                        }
            ...
            if (document.location.hash && Sena_Options.loader) {
                if (!/\?/.test(document.location.hash)) {
                    jQuery(window).on('load', function() {
                        jQuery(window).scrollTo(document.location.hash, 0, {
                            offset: {
                                top: -85,
                                left: 0
                            }
        ...
        intro: function() {
            ...
            //Fullscreen Video
                ...
                jQuery('#video-mode').on("click", function() {
                    jQuery(videoModeSelector).animate({
                        opacity: 0
                    }, {
                        duration: 500,
                        queue: false,
                ...
                $intro.on("click", function(e) {
                    if (videoMode && jQuery(e.target).is('#intro')) {
                        ...
                        jQuery('.YTPOverlay').show().animate({
                            opacity: 1
                        }, {
                            duration: 500,
                            queue: false
                        });
                        jQuery(videoModeSelector).show().animate({
                            opacity: 1
                        }, {
                            duration: 500,
                            queue: false
        ...
        portfolio: function() {
            ...
            var closeProject = function() {
                jQuery('#portfolio-details').animate({
                    opacity: 0
                }, {
                    duration: 600,
                    queue: false,
            ...
            if (/#view-/i.test(dh)) {
                ...
                if ($item.length > 0) {
                    jQuery(document).scrollTo('#portfolio', 0, {
                        offset: {
                            top: 0,
                            left: 0
                        }
            ...
            jQuery('a[href^="#view-"]').on("click", function() {
                ...
                if ($item.length > 0) {
                    jQuery(document).scrollTo('#portfolio', Sena_Options.scrollSpeed, {
                        offset: {
                            top: -85,
                            left: 0
                        },
            ...
            jQuery(window).on('load', function() {
                jQuery('.parallax').each(function() {
                    if (jQuery(this).attr('data-image')) {
                        ...
                        jQuery(this).css({
                            backgroundImage: 'url(' + jQuery(this).data('image') + ')'
                        });
                    }
                });
            });
        ...
        errorPage: function() {
            if (jQuery('#error-page').length > 0) {
                jQuery(window).on('resize', function() {
                    jQuery('#error-page').css({
                        marginTop: -Math.ceil(jQuery('#error-page').outerHeight() / 2)
                    });
                }).resize();
            }
        },
